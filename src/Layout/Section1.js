      ...
      <div className="container px-6 py-8 mx-auto">
        <div className="items-center lg:flex">
          <div className="lg:w-1/2">
            <h2 className="text-3xl font-bold text-blue-50 dark:text-gray-100">
              Who I am
            </h2>
            <p className="mt-4  dark:text-gray-400 lg:max-w-md">
              Hi I am jane , software engineer{" "}
              <a className="font-bold text-blue-600 dark:text-blue-400" href="#">
                @BakaTeam
              </a>{" "}
              , Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum in
              sed non alias, fugiat, commodi nemo ut fugit corrupti dolorem sequi ex
              veniam consequuntur id, maiores beatae ipsa omnis aliquam?
            </p>
