			...
			<div className='container px-6 py-4 mx-auto'>
					...
					<div className='w-full mx-2 lg:w-1/4'>
						<div className='px-6'>
							<div>
								<a
									href='#'
									className='text-xl text-blue-50 hover:text-gray-300'>
									Newsletter
								</a>
							</div>
							<p className='max-w-md mt-2 text-sm text-blue-50 hover:text-white'>
							...
							<div className='flex mt-4 -mx-2'>
								<a
									href='#'
									className='mx-2 text-blue-50 hover:text-white'
									aria-label='Linkden'>
				...
				<div className='text-sm text-justify text-blue-50 hover:text-white'>
					...
					<p className='my-2'>
						...
						years, sometimes now use Lorem Ipsum as their default
						model text, and a search by accident, sometimes on purpose (injected humour
						and the like).
