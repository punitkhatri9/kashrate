...
export default function Header() {
    return (
        <div>
            <nav className="flex flex-wrap items-center justify-between p-4 bg-white">
                <div className="w-auto lg:order-1 lg:w-1/5 lg:text-center">
                ...
                <div className="hidden w-full navbar-menu lg:order-2 lg:block lg:w-2/5">
                ...
                <div className="hidden w-full navbar-menu lg:order-3 lg:block lg:w-2/5 lg:text-right">
                    <a className="block mt-4 mr-5 text-blue-900 lg:inline-block lg:mt-0 hover:text-indigo-600" href="#">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    ...
                    |
                    <a className="block mt-4 ml-5 mr-10 text-blue-900 lg:inline-block lg:mt-0 hover:text-indigo-600" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 lg:inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
