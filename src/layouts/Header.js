    ...
    return (
        <div className="w-full flex flex-row items-center p-2 justify-between bg-white shadow-xs bg-indigo-500">
            ...
            <div className="flex items-center mr-8 hidden md:flex">
                <a href="https://github.com/Charlie85270/tail-kit" className="p-1 rounded-full text-white focus:outline-none hover:text-gray-200 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                ...
                <a href="#" className>
                    <svg width={2048} height={1792} fill="currentColor" className="mr-2 w-8 h-8 text-white hover:text-gray-100" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
