...
function Sectionmid() {
    return ( 
        ...
        <h2 className="text-xl font-medium text-center text-gray-800 capitalize dark:text-white md:text-2xl">
        Top Money Saving Deals
        </h2>
        <h3 className="mt-3 text-center text-gray-800 capitalize font-small dark:text-white md:text-1xl">
        ...
        <div className="flex items-center justify-center">
          <div className="grid gap-8 mt-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
            <div className="w-full max-w-xs text-center">
              <img
                className="object-cover object-center w-full mx-auto rounded-lg h-68"
